        ...
        <div className="bg-gradient-to-b  from-black   to-background-via-connect">
            ...
            <div
                ...
                <div className="leading-loose mr-20">
                    <p><span className="font-bold">Garanta Seu Passaporte Gratuíto</span> para a Blockchain Rio Festival
                        2024.</p>
                    <p><span className="font-bold">Clique no botão abaixo</span> e siga as instruções na próxima tela.
                    </p>
